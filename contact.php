                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-secondary">Etihad Town, Lahore, Pakistan</span> 
										<span class="text-secondary">F-7 markaz jinnah super market, Islamabad, Pakistan</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-secondary">+92 300 1616877 </span>
										<span class="text-secondary">+92 300 7654321 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-secondary">murtazaenem@gmail.com</span>
										<span class="text-secondary">zeeshanestates@gmail.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
